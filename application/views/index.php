...
<body>
    ...
    <div id="sidebar">
        <h3>Wielka afera W3C</h3>
           <p>Vestibulum sed diam. Aliquam ut massa in ante pellentesque viverra. Phasellus rhoncus blandit urna.</p>
        <h3>Google kupi�o Microsoft</h3>
           <p>Vestibulum sed diam. Aliquam ut massa in ante pellentesque viverra. Phasellus rhoncus blandit urna.</p>    
    </div>


    <div id="footer">Copyright &copy; 2009 by wile kwak</div>
	</div>
</body>
